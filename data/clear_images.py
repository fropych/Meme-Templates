...
image_df = pd.read_csv("data/raw_images.csv")
...
template_paths = 'data/raw_images/' + image_df[image_df.isTemplate].filename
...
image_df.to_csv(Path.cwd() / "data/images.csv", encoding="utf-8", index=False)
